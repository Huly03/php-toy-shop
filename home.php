            ...
            <div class="row mx-auto">
                ...
                <div class="card mb-3 col-3 mx-auto" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="detail.php?Maxe=<?=$row['Maxe']?>" class="text-decoration-none">
                    ...
                    <?php
                    if ($row['Soluong'] > 0) { // nếu còn hàng
                    ?>
                        <button type="submit" name="btnAddToCart" class="btn btn-warning my-3" onclick="location.href='shopcart.php?Maxe=<?=$row['Maxe']?>';">
                        <a class="text-decoration-none text-black">Thêm vào giỏ hàng <i class="fas fa-shopping-cart"></i></a>
                        </button>
                    <?php
                    } else { // nếu hết hàng
                    ?>
                        <button type="submit" name="btnAddToCart" class="btn btn-warning my-3" disabled>
                        <a class="text-decoration-none text-black">Hết hàng</a>
                        </button>
                    <?php
                    }
                    ?>
